...
import type * as _1 from 'vscode-html-languageservice';
import type * as _2 from 'vscode-languageserver-types';
...
export declare function createSourceFile(uri: string, _content: string, _version: string, context: LanguageServiceContext): {
    ...
    getVueHtmlDocument: () => _1.HTMLDocument;
    getScriptSetupData: () => {
